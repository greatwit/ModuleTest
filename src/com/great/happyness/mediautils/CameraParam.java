...
public class CameraParam {
		private final String TAG = "CameraParam";
         ...
         * @hide
         */
        public void copyFrom(CameraParam other) {
            if (other == null) {
         ...
         * @hide
         */
        public boolean same(CameraParam other) {
            if (this == other) {
                return true;
            }
            return other != null && CameraParam.this.mMap.equals(other.mMap);
        }
         ...
         *
         * <p>Use {@link CameraParam#getSupportedPreviewFormats} to get a list of
