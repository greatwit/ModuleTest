...
public class DecodeNativeActivity extends Activity implements SurfaceHolder.Callback {

	private String TAG = DecodeNativeActivity.class.getSimpleName();
	...
	public void surfaceCreated(SurfaceHolder holder) 
	{
        ...
        String readpath = GApplication.getRootPath()+"/"+"720p.h264";
        mCodec.StartDecoderTest(keys, values, holder.getSurface(), 0, readpath);
	}
